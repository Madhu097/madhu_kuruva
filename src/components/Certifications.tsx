  ...
  const certifications = [
    {
      ...
      certificateUrl: 'https://drive.google.com/file/d/1Fgf7v1H0OTpPNv0EY95uBgCmvAVl07nU/view',
    },
    {
      id: 2,
      title: 'Python',
      ...
      certificateUrl: 'https://drive.google.com/file/d/1CiS4NMxk9M9EMco_3bWceTJBfYh4qZrC/view',
    },
    {
      id: 3,
      title: 'Pantech Internship',
      issuer: 'pantech e Learning',
      date: '2025',
      icon: Sparkles,
      gradient: 'from-blue-500 to-purple-500',
      description: 'web development internship covering full stack development',
      certificateUrl: 'https://drive.google.com/file/d/1iD7fk8LdTAkDJhe6-rlbL2TFu6iEf-NE/view',
    },
    {
      id: 4,
      title: 'Java ',
      ...
      description: ' completed java programming from basics to advanced',
      certificateUrl: 'https://drive.google.com/file/d/1qYxtOBU0OxWaXqE1__R9UUFhmmYuO1Me/view   ',
    },
    {
      id: 5,
      ...
      description: ' Gained knowledge in MySQL database design, queries, and management',
      certificateUrl: 'https://drive.google.com/file/d/1NF3CUm55fnCbV4Y3uksVjcZyiFu_Wv5p/view',
    },
    {
      id: 6,
      ...
      description: 'Comprehensive understanding of Cloud IoT and Edge Machine Learning',
      certificateUrl: 'https://drive.google.com/file/d/1DFsCZBrEYIwXH0g7kWHcMC_uUH1gm1RU/view',
    },
    {
      id: 7,
      ...
      icon: Shield,
      gradient: 'from-cyan-500 to-blue-500',
      description: 'Completed a data analytics job simulation program by Deloitte',
      certificateUrl: 'https://drive.google.com/file/d/1kZwP-8Mo8O17_z6XN1xd-MszGf2blayS/view?usp=drive_open',
    }
  ];
